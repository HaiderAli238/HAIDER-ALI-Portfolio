...
const Services = () => {
  return (
    <section id="services" className="py-24 bg-[#020617] relative overflow-hidden">
      {/* Deep Glow Background Blobs - Matches Skills Section */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, idx) => (
            <motion.div
              ...
              // Weighted Hover Effect - Matches Skills Box Style
            ...
            >
              ...
              {/* Bottom Line Accent - Just like Skills Section */}
